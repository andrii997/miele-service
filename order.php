...
<html lang="ru-RU">
	<head>
		...
		<meta property="og:url" content="https://the.andrew.pp.ua/order.php">
		<title>Обращение | Miele Service — Ремонт техники Миле в Киеве и области</title>
		<meta property="og:title" content="Обращение">
		<meta property="twitter:title" content="Обращение">
		...
		<meta name="keywords" content="Обращение">
		<!-- ГРАФИКА -->
		...
		<meta name="twitter:image:alt" content="Обращение | Miele Service">
		<!-- FAVICON -->
		...
		<link rel="alternate" type="application/json+oembed" href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthe.andrew.pp.ua%2Forder" />
		<link rel="alternate" type="text/xml+oembed" href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthe.andrew.pp.ua%2Forder&#038;format=xml" />
	</head>
	<body>
		...
		<section class="template-speed-page fk-bg-light-md">
			<div class="fk-section">
				<div class="fk-container-xs">
					<div class="template-speed-page__form fk-shadow-box">
						<header class="title">
							<h2>Обращение в Miele Service</h2>
							<p class="fk-ff-title mt-xs fz-lg">Благодарим Вас за выбор нашей компании! <br>Отправьте сообщение. Мы перезвоним в течении 15 минут.</p>
						</header>
						<form id="form-order" action="/order-action.php" class="fk-form fk-form_extend" method="post">
							<p><input name="field-name" type="text" placeholder="Имя" value=""></p>
							<p><input name="field-phone" type="tel" placeholder="Телефон *" value="" autofocus required></p>
							<p class="fk-btn-box fk-btn-box_extend">
								<button type="submit" class="fk-btn-cta fk-btn_mg">Отправить <i class="fk-icon-stroke-right" fk-icon="lonicons/md/arrow-forward"></i></button>
							</p>
							<p class="fk-ff-title text-center fz-xs">Отправляя данные вы принимаете Пользовательское соглашение нашей
								компании.
							</p>
							<input type="hidden" name="action" value="order">
							<input type="hidden" name="sx-form-page-url" value="">
							<input type="hidden" name="sx-form-page-title" value="">
							<input type="hidden" name="sx-post-order-type" value="">
						</form>
					</div>
				</div>
			</div>
		...
		<script>
			<?php
				if(isset($_POST['sx-post-auto-send']) && $_POST['sx-post-auto-send'] == 'true'){
				?>
